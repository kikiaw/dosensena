...
<?php require_once("aside-left.php"); ?>
                <main id="main" class="">
                   <?php
                        ...
                        // Untuk mengambil nama kategori
                        $result = $conn->query("select nama_kategori from kategori where id_kategori = $kategori");
                    ...
                    $result = $conn->query("select * from berita where id_kategori = $kategori");
                        ...
                        <nav aria-label="Page navigation">
                          <ul class="pagination">
                           <?php
                            ...
                            if($halaman > 1){
                                $link = $halaman-1;
                                $prev = "<li><a href=\"kategori.php?k=$kategori&hal=$link\">Sebelumnya</a></li>";
                            }else{
                                $prev = "";
                            }
                            ...
                            if($halaman < $jumlah_hal){
                                $link = $halaman+1;
                                $next = "<a href=\"kategori.php?k=$kategori&hal=$link\">Selanjutnya</a>";
                            }else{
                                $next = "";
                            }
